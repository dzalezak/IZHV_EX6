    ...
    private void MainWindowUI(int windowId)
    {
        ...
        { // Main Window Area
            ...
            GUILayout.BeginVertical();
            {
                 ...
                 */
                GameManager.Instance.interactiveMode = GUILayout.Toggle(GameManager.Instance.interactiveMode, "Interact");
                GUILayout.BeginHorizontal();
                {
                    ...
                    bool mute = GUILayout.Button("Mute", GUILayout.Width(WINDOW_DIMENSION.x / 4.0f));
                    if(mute){
